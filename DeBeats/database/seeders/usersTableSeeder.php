...
class usersTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            [
                'name' => 'Dr. Mohamad Shukor bin Talib',
                'UTMID' => 'shukor',
                'email' => 'shukor@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Alif Ridzuan bin Khairuddin',
                'UTMID' => 'alif',
                'email' => 'alif@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Ts. Dr. Muhammad Iqbal Tariq bin Idris',
                'UTMID' => 'iqbal',
            ...
            [
                'name' => 'Dr. Mohd Fo\'ad bin Rohani',
                'UTMID' => 'foad',
                'email' => 'foad@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Ts. Ms. Hazinah binti Kutty Mammi',
                'UTMID' => 'hazinah',
                'email' => 'hazinah@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                ...
                'UTMID' => 'izyan',
                'email' => 'izyan@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Jamilah binti Mahmood',
                'UTMID' => 'jamilah',
                'email' => 'jamilah@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Pang Yee Yong',
                'UTMID' => 'pang',
                'email' => 'pang@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Nur Zuraifah Syazrah binti Othman',
                'UTMID' => 'zuraifah',
                'email' => 'zuraifah@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Shafaatunnur binti Hassan',
                'UTMID' => 'shafaatunnur',
                'email' => 'shafaatunnur@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Assoc. Prof. Dr. Shahida binti Sulaiman',
                'UTMID' => 'shahida',
                'email' => 'shahida@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                ...
                'UTMID' => 'sah',
                'email' => 'sah@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Norhaida binti Mohd Suaib',
                'UTMID' => 'norhaida',
                'email' => 'norhaida@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
                'name' => 'Dr. Aida binti Ali',
                'UTMID' => 'aida',
                'email' => 'aida@domain.com',
                'password' => Hash::make('lecturerpassword'),
                'role' => 'lecturer', 
            ],
            [
